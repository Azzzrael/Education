...
public class MainTelephone {
    public static void main(String[] args) {
        ...
        if (calc[3]>calc[0]){
            System.out.println("Vi privisili limit na  " + difference + " minut, po etomu plata sostavit "+overlimit+" grn.");
        } else {
            System.out.println("Plata sostavit " + inlimit+ " grn, soglasno tarifu");
        }
